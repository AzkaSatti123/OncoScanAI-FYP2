    ...
    <div className="min-h-screen flex items-center justify-center font-sans"
      ...
      <div className="w-full max-w-md px-4">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-1 text-sm text-slate-500">Log in to your diagnostic platform</p>
        </div>
        ...
        <div className="rounded-2xl border shadow-xl p-8"
          ...
          {resetSent && (
            <div className="mb-5 flex items-start gap-2.5 px-4 py-3 rounded-xl bg-green-50 border border-green-100 text-green-700 text-sm">
              <svg className="w-4 h-4 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
          ...
          <p className="mt-6 text-center text-sm text-slate-500">
            ...
            <Link to="/signup" className="font-black text-brand-pink hover:underline">
              Sign up
            </Link>
          </p>
        </div>
